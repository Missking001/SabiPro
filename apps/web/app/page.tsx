    ...
    <>
      ...
      <section className="bg-primary-base text-neutral-0 relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8 pt-16 pb-24 md:pt-20 md:pb-32">
          ...
          {/* Search bar */}
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center bg-neutral-0 rounded-component max-w-xl overflow-hidden shadow-lg">
            <div className="flex items-center gap-3 flex-1 px-4 py-3">
              ...
              <span className="text-body text-neutral-500">What service do you need?</span>
            </div>
            <Link href="/search" className="sm:m-1.5">
              <Button
                size="md"
                className="w-full sm:w-auto !bg-secondary-base hover:!bg-secondary-hover !text-neutral-900 !rounded-component !font-medium !px-6"
              >
                Find a Pro
              </Button>
            </Link>
